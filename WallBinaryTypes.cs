...
public static class WallBinaryTypes //Using Binary to set each tile type
{
    //Clockwise direction starting from up for cardinal and top left for diagnonal
    //First 4 digits are cardinal, Second 4 digits are diagnoal (ignore 0b)
    //1 is a tile exists and 0 is a tile does not exist
    //These are all the rules for each tile
